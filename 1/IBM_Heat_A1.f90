...
!     double precision, parameter :: Cm = 1.0/Re, Ce = 1.0/(Re*Pr)
    ...
    double precision, parameter :: MaxCFL = 5., dt = 1.0e-06


    ! DOMAIN SIZE FOR THE PHYSICAL PROBLEMS
    double precision, parameter :: r = 0.16, ALX = 1.0, ALY = 1.0

    double precision, parameter :: XMIN = -0.5, XMAX = XMIN + ALX
    double precision, parameter :: YMIN = -0.5, YMAX = YMIN + ALY
